import { getSingleProduct } from "@/Data/fetchData";
import { singleFullProduct } from "@/Data/types";
...
export default async function ProductPage({
  ...
  const data: singleFullProduct = await getSingleProduct(params.slug);
// console.log(data);

  return (
    <div className="bg-white mx-auto max-w-2xl px-4 lg:max-w-7xl lg:px-8">
          ...
          <div className="md:py-8">
            ...
            <div className="mb-6 flex items-center gap-3 md:mb-10">
               <Button className="rounded-full">
                <span className="text-sm mx-1">4.2</span>
            ...
            <div className="flex items-end gap-2">
              <span className="text-xl font-bold text-gray-700 md:text-2xl">
                ${data.price}
              </span>
